...
const CollegeCards = () => {
    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-3 gap-6 my-10 mx-auto justify-items-center">
                {
                    searchedColleges.map((searchedCollege) => <div key={searchedCollege._id}>
                        ...
                        <div className="card w-[450px] h-[800px] glass font-serif">
                            ...
                            <div className="card-body">
                                ...
                                <p><span  className="underline">Admission Data:</span> {searchedCollege.admissionDate}</p>
                                ...
                                <div className="card-actions justify-end">
                                    <button className="btn btn-primary"><Link to="/">Details</Link></button>
                                </div>
                            </div>
                        </div>
